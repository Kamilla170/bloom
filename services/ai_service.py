...
СТРУКТУРА ОТВЕТА:
1. Диагноз/оценка ситуации (что происходит)
2. Причина (почему это происходит)
3. Конкретные действия (что делать)
4. Сроки/контроль результата (когда ожидать изменений)

Будьте кратким (2-3 абзаца), но исчерпывающим. Каждое утверждение должно быть обоснованным."""
...
Дайте профессиональный ответ (2-3 абзаца):
1. ОЦЕНКА: Диагноз/текущая ситуация
2. ПРИЧИНА: Что вызвало проблему/ситуацию
3. РЕШЕНИЕ: Конкретные действия с параметрами
4. КОНТРОЛЬ: Когда ожидать результат
